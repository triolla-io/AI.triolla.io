    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-background/80 backdrop-blur-xl">
        <div className="max-w-[1400px] mx-auto px-8 h-20 flex items-center justify-between">
          <a href="https://triolla.io" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5">
          ...
          <a href="https://triolla.io" target="_blank" rel="noopener noreferrer" className="flex items-center" aria-label="Triolla">
            <svg xmlns="http://www.w3.org/2000/svg" width="92" height="30" viewBox="0 0 92 30" fill="none" className="h-5 sm:h-7 w-auto">
      ...
      <section className="pt-48 pb-32 px-8">
        <div className="max-w-[1400px] mx-auto">
          ...
          {/* big stat row */}
          <div className="mt-20 md:mt-32 grid grid-cols-1 sm:grid-cols-3 gap-px bg-border max-w-4xl mx-auto rounded-3xl overflow-hidden border border-border">
            {[
              { v: "60", s: "ימים", d: "מ-0 לתוצאה" },
              { v: "2–3", s: "תהליכים", d: "חיים בארגון" },
              { v: "100%", s: "ביצוע", d: "לא דיבורים" },
            ].map((s) => (
              <div key={s.d} className="bg-background p-6 sm:p-8 text-center">
                <div className="text-4xl sm:text-5xl md:text-6xl font-medium tracking-tighter-x">
      ...
      <footer className="border-t border-border px-8 py-10">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div dir="ltr" className="flex flex-col items-center md:items-start gap-1.5 text-center md:text-left">
